...
public class UsuarioSecurityTest extends UsuarioTestBase {
    ...
    @Description("Valida se o endpoint DELETE aceita exclusão sem autenticação e se responde corretamente")
    ...
    @Description("Valida o comportamento do endpoint DELETE quando enviado token inválido")
